		...
		<div class="col-md-6" style="margin-top:30px">
				...
				<form class="form-horizontal" method="post" action="posts/create" >
				  ...
				  <div class="form-group"  >
					...
					<div class="col-sm-10">
					  <input type="text" name="title" class="form-control custom-text" id="inputTitle" placeholder="Title input here..." style="width:100%;" value="<?php if (Input::post('title')) echo Input::post('title');?>">
					</div>
				  </div>
				  <div class="form-group">
					<label for="inputContent" class="col-sm-2 control-label" style="text-align:left;margin-left:0px;padding-left:0px;">Content</label>
					<div class="col-sm-10">
					 <textarea class="form-control" rows="10" name="content"><?php if (Input::post('content')) echo Input::post('content');?></textarea>
					</div>
				  </div>
				  <div class="form-group">
	 ...
	 <hr>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<p><i>Post date : <?php echo date('Y-m-d H:i:m', $post['time'])?>
				<br />
				   Modified date :<?php echo date('Y-m-d H:i:m', $post['time'])?>
				   </i>
				</p>
